...
#define WSIG 1
#define CSIG 2
ui64           judgeActualHash[] = {          10000000120ULL,          10000000126ULL,          10000000120ULL,          10000000120ULL,          10000000120ULL,          10000000119ULL,          10000000120ULL,          10000000119ULL,          10000000119ULL,          10000000119ULL};
ui64         judgeWSIgnoreHash[] = {                   50ULL,                   56ULL,                   50ULL,                   50ULL,                   50ULL,                   49ULL,                   50ULL,                   49ULL,                   49ULL,                   49ULL};
ui64    judgeWS_CaseIgnoreHash[] = {                   50ULL,                   56ULL,                   50ULL,                   50ULL,                   50ULL,                   49ULL,                   50ULL,                   49ULL,                   49ULL,                   49ULL};
